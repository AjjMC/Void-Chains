...
give @s minecraft:gray_stained_glass_pane[minecraft:custom_data={ajjgui:{widget:"counter",values:[5,10,15,20,25,30],command:"function map:gui/play/anchor_settings/anchor_claiming_duration"}},minecraft:item_name={text:"Change",color:"yellow"}] 5
...
give @s minecraft:gray_stained_glass_pane[minecraft:custom_data={ajjgui:{widget:"counter",values:[15,20,25,30,5,10],command:"function map:gui/play/anchor_settings/anchor_generation_duration"}},minecraft:item_name={text:"Change",color:"yellow"}] 15
