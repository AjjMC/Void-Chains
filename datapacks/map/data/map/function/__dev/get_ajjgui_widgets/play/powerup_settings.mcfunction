...
give @s minecraft:gray_stained_glass_pane[minecraft:custom_data={ajjgui:{widget:"counter",values:[30,35,40,45,50,55,60,15,20,25],command:"function map:gui/play/powerup_settings/powerup_generation_period"}},minecraft:item_name={text:"Change",color:"yellow"}] 30
...
give @s minecraft:gray_stained_glass_pane[minecraft:custom_data={ajjgui:{widget:"counter",values:[30,35,40,45,50,55,60,15,20,25],command:"function map:gui/play/powerup_settings/powerup_effect_duration"}},minecraft:item_name={text:"Change",color:"yellow"}] 30
...
give @s minecraft:gray_stained_glass_pane[minecraft:custom_data={ajjgui:{widget:"counter",values:[15,20,25,30,35,40,45,50,55,60,5,10],command:"function map:gui/play/powerup_settings/powerup_timeout_duration"}},minecraft:item_name={text:"Change",color:"yellow"}] 15
