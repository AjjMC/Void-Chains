...
give @s minecraft:gray_dye[minecraft:custom_data={ajjgui:{widget:"switch",items:[{id:"minecraft:gray_dye",count:1,components:{"minecraft:item_name":{text:"Change",color:"yellow"},"minecraft:lore":[{text:"Disabled",color:"red",italic:0b}]}},{id:"minecraft:magenta_dye",count:1,components:{"minecraft:item_name":{text:"Change",color:"yellow"},"minecraft:lore":[{text:"Enabled",color:"light_purple",italic:0b}]}}],command:"function map:gui/play/general_settings/developer_tools"}},minecraft:item_name={text:"Change",color:"yellow"},minecraft:lore=[{text:"Disabled",color:"red",italic:0b}]]
