...
give @s minecraft:gray_stained_glass_pane[minecraft:custom_data={ajjgui:{widget:"counter",values:[3,4,5,6,1,2],command:"function map:gui/anchor_starting_count",state:2}},minecraft:custom_name={text:"Click to change",color:"yellow",italic:0b}] 3
...
give @s minecraft:barrier[minecraft:custom_data={ajjgui:{widget:"button",command:"function map:gui/reset_anchor_settings"}},minecraft:custom_name={text:"Reset Anchor Settings",color:"red",italic:0b}]
