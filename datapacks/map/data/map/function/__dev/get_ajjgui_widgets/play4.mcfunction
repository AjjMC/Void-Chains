...
give @s minecraft:brown_stained_glass_pane[minecraft:custom_data={ajjgui:{widget:"counter",values:[1,2,3,4,5],command:"function map:gui/powerup_generation_minutes"}},minecraft:custom_name={text:"Click to change",color:"yellow",italic:0b}] 1
...
give @s minecraft:barrier[minecraft:custom_data={ajjgui:{widget:"button",command:"function map:gui/reset_powerup_settings"}},minecraft:custom_name={text:"Reset Powerup Settings",color:"red",italic:0b}]
