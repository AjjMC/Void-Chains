...
give @p minecraft:bow[minecraft:custom_name=[{text:"Select ",color:"green",italic:0b},{text:"Archer Kit",color:"dark_green"}],minecraft:lore=[{text:"- Wooden Sword",color:"gray",italic:0b},{text:"- Bow (x12 Arrow)",color:"gray",italic:0b}]]
...
give @p minecraft:bow[minecraft:custom_data={ajjgui:{widget:"button",command:"function map:dev/select_archer_kit",exit:1b}},minecraft:custom_name=[{text:"Select ",color:"green",italic:0b},{text:"Archer Kit",color:"dark_green"}],minecraft:lore=[{text:"- Wooden Sword",color:"gray",italic:0b},{text:"- Bow (x12 Arrow)",color:"gray",italic:0b}]]
