...
execute if score @s ajjgui.state matches 0 run tellraw @a [{text:"Set Locked Play GUI to Disabled"}]
execute if score @s ajjgui.state matches 1 run tellraw @a [{text:"Set Locked Play GUI to Enabled"}]
