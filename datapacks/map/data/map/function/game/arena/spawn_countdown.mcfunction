...
execute if score #countdown_seconds map.global matches 1.. run tellraw @a [{text:"Starting in ",color:"yellow"},{score:{name:"#countdown_seconds",objective:"map.global"},color:"gold"}]
