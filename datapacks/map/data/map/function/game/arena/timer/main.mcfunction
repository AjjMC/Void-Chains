execute if score #border_shrinking map.global matches 0 run function map:game/arena/timer/display
execute if score #border_shrinking map.global matches 1 run function map:game/arena/border/main
