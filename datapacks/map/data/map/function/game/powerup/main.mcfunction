...
execute if score #powerup_generation map.global matches 1 if score #powerup_minutes map.global = #powerup_generation_period map.global at @e[type=minecraft:marker,tag=map.arena] run function map:game/powerup/generate
