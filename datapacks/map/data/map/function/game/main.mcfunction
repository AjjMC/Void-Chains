...
execute unless entity @e[type=minecraft:marker,tag=map.red_anchor] unless entity @a[team=map.red,tag=!map.dead] run function map:events/blue_team_win
execute unless entity @e[type=minecraft:marker,tag=map.blue_anchor] unless entity @a[team=map.blue,tag=!map.dead] run function map:events/red_team_win

execute unless entity @a[team=!map.guest] run function map:events/draw