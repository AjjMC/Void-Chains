...
execute if score #temp map.global matches 18 unless entity @a[tag=map.attacker] if entity @s[tag=!map.active_powerup] run tellraw @a [{selector:"@s"},{text:" got tired and fell",color:"white"}]
execute if score #temp map.global matches 18 if entity @a[tag=map.attacker] if entity @s[tag=!map.active_powerup] run tellraw @a [{selector:"@s"},{text:" got tired and fell while trying to escape ",color:"white"},{selector:"@a[tag=map.attacker]"}]
...
execute if score #temp map.global matches 19 unless entity @a[tag=map.attacker] if entity @s[name=Ajj] run tellraw @a [{selector:"@s"},{text:" forgot to activate his backdoor and fell",color:"white"}]
execute if score #temp map.global matches 19 if entity @a[tag=map.attacker] if entity @s[name=Ajj] run tellraw @a [{selector:"@s"},{text:" forgot to activate his backdoor and fell while trying to escape ",color:"white"},{selector:"@a[tag=map.attacker]"}]