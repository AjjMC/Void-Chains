execute if entity @s[team=map.red] run function map:game/entity/red_team
execute if entity @s[team=map.blue] run function map:game/entity/blue_team
...
execute positioned ~-37.5 ~-64 ~-37.5 unless entity @e[type=minecraft:marker,tag=map.arena,dx=74,dy=72,dz=74] run function map:game/player/void_death
...
function map:game/item/check/all_kits
