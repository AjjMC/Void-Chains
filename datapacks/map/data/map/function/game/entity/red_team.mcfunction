...
execute if entity @s[tag=map.anchor_powerup] positioned ~ 62 ~ if block ~ ~ ~ #map:game/red_wool run tag @s add map.acting_anchor
execute if entity @s[tag=map.acting_anchor] positioned ~ 62 ~ unless block ~ ~ ~ #map:game/red_wool run schedule function map:game/anchor/stability/main 1t
execute positioned ~ 62 ~ unless block ~ ~ ~ #map:game/red_wool run tag @s remove map.acting_anchor
...
execute if score #anchor_generation_ability map.global matches 0 if predicate map:game/stepping_on_red run title @s actionbar {text:"Sprint to Form a Bridge"}
execute if score #anchor_generation_ability map.global matches 1 if predicate map:game/stepping_on_red_concrete run title @s actionbar {text:"Sprint to Form a Bridge"}
...
execute if predicate map:game/stepping_on_blue_concrete unless predicate map:game/charging_anchor run title @s actionbar {text:"Hold Sneak to Claim the Anchor"}
