...
execute if entity @s[tag=map.hunter] run function map:game/item/equip/kit/hunter
execute if entity @s[tag=map.acrobat] run function map:game/item/equip/kit/acrobat
