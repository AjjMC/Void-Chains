...
data modify block ~ ~ ~ Items[] set value {Slot:0b,id:"minecraft:creeper_spawn_egg",count:1,components:{"minecraft:custom_data":{map:{item:1b,creeper_egg:1b}},"minecraft:can_place_on":[{blocks:"#map:game/arena"}],"minecraft:tooltip_display":{hidden_components:["minecraft:can_place_on"]},"minecraft:entity_data":{id:"minecraft:creeper",CustomNameVisible:1b,Invulnerable:1b,NoAI:1b,ExplosionRadius:4b,ignited:1b,Tags:["map.creeper","map.new"]}}}
