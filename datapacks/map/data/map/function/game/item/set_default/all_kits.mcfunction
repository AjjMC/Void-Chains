execute if entity @s[tag=map.knight] run function map:game/item/set_default/kit/knight
execute if entity @s[tag=map.archer] run function map:game/item/set_default/kit/archer
