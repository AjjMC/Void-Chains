execute if entity @s[tag=map.anchor_powerup] at @s positioned ~ 62 ~ unless block ~ ~ ~ #map:game/red_wool run schedule function map:game/mechanics/main 1t

execute unless entity @s[tag=map.bridge_powerup] if predicate map:game/stepping_on_red if predicate map:game/sprinting store success score #temp map.global run fill ~-2 62 ~-1 ~2 62 ~1 minecraft:red_wool replace #map:game/red_replaceable
...
execute unless entity @s[tag=map.bridge_powerup] if predicate map:game/stepping_on_red if predicate map:game/sprinting store success score #temp map.global run fill ~-1 62 ~-2 ~1 62 ~2 minecraft:red_wool replace #map:game/red_replaceable
execute unless entity @s[tag=map.bridge_powerup] if score #temp map.global matches 1 run schedule function map:game/mechanics/main 1t
...
execute if score #anchor_generation map.global matches 1 if entity @s[tag=map.generating_anchor] unless predicate map:game/stepping_on_red_wool if predicate map:game/charging_anchor run function map:game/anchor/reset_charge

execute if entity @s[tag=map.active_powerup] run return fail
execute if predicate map:general/using_gui run return fail

execute if score #anchor_generation map.global matches 0 if predicate map:game/stepping_on_red run title @s actionbar {text:"Sprint to Form Bridge"}
execute if score #anchor_generation map.global matches 1 if predicate map:game/stepping_on_red_concrete run title @s actionbar {text:"Sprint to Form Bridge"}
...
execute if score #anchor_generation map.global matches 0 if predicate map:game/stepping_on_blue_wool run title @s actionbar {text:"You Are on Enemy Territory"}
execute if score #anchor_generation map.global matches 1 if predicate map:game/stepping_on_blue_wool unless predicate map:game/charging_anchor run title @s actionbar {text:"You Are on Enemy Territory"}