execute if entity @s[tag=map.anchor_powerup] at @s positioned ~ 62 ~ unless block ~ ~ ~ #map:game/red_wool run schedule function map:game/arena/mechanics/main 1t
...
execute if predicate map:game/stepping_on_blue_concrete if predicate map:game/charging_anchor align xyz positioned ~0.5 ~-1 ~0.5 run function map:game/arena/anchor/charge_claim
execute if entity @s[tag=map.claim_anchor] unless predicate map:game/stepping_on_blue_concrete if predicate map:game/charging_anchor run function map:game/arena/anchor/reset_charge
...
execute if score #anchor_generation map.global matches 1 if entity @s[tag=map.generate_anchor] unless predicate map:game/stepping_on_red_wool if predicate map:game/charging_anchor run function map:game/arena/anchor/reset_charge
