...
execute if score #anchor_generation_ability map.global matches 1 if predicate map:game/stepping_on_red_wool if predicate map:game/charging_anchor align xyz positioned ~0.5 ~-1 ~0.5 positioned ~-37.5 ~-0.5 ~-37.5 if entity @e[type=minecraft:marker,tag=map.arena,dx=74,dy=1,dz=74] positioned ~37.5 ~0.5 ~37.5 positioned ~-3 ~-0.5 ~-3 unless entity @e[type=minecraft:marker,tag=map.anchor,dx=5,dy=1,dz=5] positioned ~3 ~0.5 ~3 run function map:game/anchor/charge_generate
...
execute if score #anchor_generation_ability map.global matches 1 if predicate map:game/stepping_on_red_wool if predicate map:game/charging_anchor align xyz positioned ~0.5 ~-1 ~0.5 positioned ~-37.5 ~-0.5 ~-37.5 unless entity @e[type=minecraft:marker,tag=map.arena,dx=74,dy=1,dz=74] run function map:game/anchor/reset_charge
...
execute if score #anchor_generation_ability map.global matches 1 if predicate map:game/stepping_on_red_wool unless predicate map:game/charging_anchor align xyz positioned ~0.5 ~-1 ~0.5 positioned ~-37.5 ~-0.5 ~-37.5 unless entity @e[type=minecraft:marker,tag=map.arena,dx=74,dy=1,dz=74] run title @s actionbar {text:"Sprint to Form the Bridge"}
...
execute if score #anchor_generation_ability map.global matches 1 if predicate map:game/stepping_on_red_wool unless predicate map:game/charging_anchor align xyz positioned ~0.5 ~-1 ~0.5 positioned ~-37.5 ~-0.5 ~-37.5 if entity @e[type=minecraft:marker,tag=map.arena,dx=74,dy=1,dz=74] positioned ~37.5 ~0.5 ~37.5 positioned ~-3 ~-0.5 ~-3 unless entity @e[type=minecraft:marker,tag=map.anchor,dx=5,dy=1,dz=5] run title @s actionbar {text:"Sprint to Form the Bridge | Hold Crouch to Generate an Anchor"}
