...
execute as @a[tag=map.using_gui] unless predicate map:general/using_gui run function map:general/gui/finish
...
tag @s[tag=!map.knight,tag=!map.archer,tag=!map.warrior,tag=!map.miner,tag=!map.alchemist,tag=!map.wildcard,tag=!map.pyro] add map.knight
