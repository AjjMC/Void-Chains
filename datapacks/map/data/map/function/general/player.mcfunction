...
execute if block ~ ~-1 ~ minecraft:slime_block run effect give @s minecraft:jump_boost infinite 19 true
execute unless block ~ ~-1 ~ minecraft:slime_block run effect clear @s minecraft:jump_boost
