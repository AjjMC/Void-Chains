...
execute if entity @s[team=] run team join map.no @s
execute if entity @s[tag=map.using_gui] unless predicate map:general/using_gui run function map:gui/general/finish
