...
execute unless items entity @s hotbar.4 *[minecraft:custom_data~{map:{join_red_team:1b}}] run function map:lobby/equip_player
execute unless items entity @s hotbar.5 *[minecraft:custom_data~{map:{join_blue_team:1b}}] run function map:lobby/equip_player
