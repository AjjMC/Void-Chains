...
execute if score #game_winner map.global matches 1 run function map:lobby/stats/display/red_team_win
execute if score #game_winner map.global matches 2 run function map:lobby/stats/display/blue_team_win

summon minecraft:text_display 0 55 0 {Tags:["map.stats"]}

execute if score #game_minutes map.global matches ..9 if score #game_seconds map.global matches ..9 run data modify entity @e[type=minecraft:text_display,tag=map.stats,limit=1] text set value [{text:"Duration: ",color:"gray",italic:0b},{text:"0",color:"gold"},{score:{name:"#game_minutes",objective:"map.global"},color:"gold"},{text:":0",color:"gold"},{score:{name:"#game_seconds",objective:"map.global"},color:"gold"}]
execute if score #game_minutes map.global matches ..9 if score #game_seconds map.global matches 10.. run data modify entity @e[type=minecraft:text_display,tag=map.stats,limit=1] text set value [{text:"Duration: ",color:"gray",italic:0b},{text:"0",color:"gold"},{score:{name:"#game_minutes",objective:"map.global"},color:"gold"},{text:":",color:"gold"},{score:{name:"#game_seconds",objective:"map.global"},color:"gold"}]
execute if score #game_minutes map.global matches 10.. if score #game_seconds map.global matches ..9 run data modify entity @e[type=minecraft:text_display,tag=map.stats,limit=1] text set value [{text:"Duration: ",color:"gray",italic:0b},{score:{name:"#game_minutes",objective:"map.global"},color:"gold"},{text:":0",color:"gold"},{score:{name:"#game_seconds",objective:"map.global"},color:"gold"}]
