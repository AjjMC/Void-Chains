...
execute positioned 0 55 1 run function map:lobby/stats/save/red_team_players
execute positioned 0 55 -1 run function map:lobby/stats/save/blue_team_players
