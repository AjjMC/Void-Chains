...
item replace entity @s hotbar.0 with minecraft:written_book[minecraft:custom_data={map:{item:1b,game_info:1b}},minecraft:tooltip_display={hidden_components:["minecraft:written_book_content"]},minecraft:enchantment_glint_override=false,minecraft:written_book_content={pages:[ \
    ...
    ],title:"Game Info",author:Ajj},minecraft:lore=[{text:"Void Chains [1.13.0]",color:"gray",italic:0b}]]

function map:lobby/item/update_team_buttons

item replace entity @s hotbar.8 with minecraft:compass[minecraft:custom_data={map:{item:1b,player_settings_button:1b}},minecraft:consumable={consume_seconds:2147483647f},minecraft:use_effects={can_sprint:true,speed_multiplier:1f},minecraft:custom_name=[{text:"Your Settings",color:"green",italic:0b},{text:" (Right Click)",color:"gray"}]]
