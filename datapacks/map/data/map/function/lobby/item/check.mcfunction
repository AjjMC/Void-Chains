execute if entity @s[team=map.no] if items entity @s hotbar.3 minecraft:magenta_wool[minecraft:custom_data~{map:{no_team_button:1b}}] run function map:lobby/item/update_team_buttons
...
execute unless items entity @s[tag=map.moderation] hotbar.1 *[minecraft:custom_data~{map:{moderation_button:1b}}] run function map:lobby/item/equip_player
execute unless items entity @s hotbar.3 *[minecraft:custom_data~{map:{no_team_button:1b}}] run function map:lobby/item/equip_player
execute unless items entity @s[tag=map.cosmetics] hotbar.7 *[minecraft:custom_data~{map:{cosmetics_button:1b}}] run function map:lobby/item/equip_player
execute unless items entity @s hotbar.8 *[minecraft:custom_data~{map:{kits_button:1b}}] run function map:lobby/item/equip_player
