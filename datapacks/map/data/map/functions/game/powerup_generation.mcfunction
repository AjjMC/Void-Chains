...
execute at @e[type=minecraft:item,tag=powerup] if block ~ ~-1 ~ minecraft:air run particle minecraft:lava ~ ~1 ~ 1 1 1 0 10
execute at @e[type=minecraft:item,tag=powerup] unless block ~ ~-1 ~ minecraft:air run particle minecraft:firework ~ ~1 ~ 1 1 1 0 10