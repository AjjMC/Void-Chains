execute unless data entity @s Inventory[{Slot:0b,tag:{Sword:1b}}] run function map:game/equip_blue_team
execute if score #developer_tools global matches 1 unless data entity @s Inventory[{Slot:8b,tag:{DeveloperTools:1b}}] run function map:game/equip_blue_team
