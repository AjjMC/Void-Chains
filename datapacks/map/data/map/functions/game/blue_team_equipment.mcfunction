execute unless data entity @s Inventory[{Slot:0b,tag:{map:{Sword:1b}}}] run function map:game/equip_blue_team
execute unless data entity @s Inventory[{Slot:-106b,tag:{map:{Shield:1b}}}] run function map:game/equip_blue_team
