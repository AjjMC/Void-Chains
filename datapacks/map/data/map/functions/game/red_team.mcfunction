...
execute if score #anchor_generation global matches 0 if predicate map:game/stepping_on_red_wool unless predicate map:game/charging_anchor run title @s actionbar {"text":"Sprint on your color to bridge"}

execute if score #anchor_generation global matches 1 if predicate map:game/stepping_on_red_wool unless predicate map:game/charging_anchor run title @s actionbar {"text":"Hold crouch to generate anchor"}
...
execute if predicate map:game/stepping_on_red_concrete run title @s actionbar {"text":"Sprint on your color to bridge"}