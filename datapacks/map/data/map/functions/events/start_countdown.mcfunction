execute if score #countdown_seconds global matches 1.. run title @a subtitle [{"text":"Teleportation in ","color":"yellow"},{"score":{"name":"#countdown_seconds","objective":"global"}}]
