...
execute if score #random_team_assignment map.global matches 1 run tellraw @a[team=!map.guest] [{"text":"Joined "},{"text":"Guest Team ","color":"white"},{"text":"as teams will be randomly assigned"}]
