...
execute if score #developer_tools global matches 1 if entity @a[team=!guest] run tellraw @a {"text":"Starting game with Developer Tools enabled","color":"light_purple"}
